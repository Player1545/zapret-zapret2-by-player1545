...
<p>На desktop версии используйте прокси. Так же можете использовать эту программу от Flowseal: <a href="https://github.com/Flowseal/tg-ws-proxy">tg-ws-proxy</a></p>
