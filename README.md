...
<br>
<p><b>!ВНИМАНИЕ! На момент 27.12.2025 могут не работать вообще все стратегии из данного репозитория. Я пытаюсь решить эту проблему, однако пока что всё безуспешно и к сожалению у меня кончаются идеи для возможных методов решения. Временно рекомендую перейти на стратегию general(ALT11) или general(SIMPLE FAKE) из репозитория zapret-discord-youtube от Flowseal.</b></p>
<br>
<hr>
<h2>Как запускать?</h2>
