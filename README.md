...
<p>Второе уточнение: Вы не сможете через service.bat установить zapret как сервис. Подробнее читайте в самом низу на этой странице.</p>
...
<ul>
  ...
  <li><b>service.bat</b> - батник с полезными инструментами по типу удаления сервиса, запуска игрового фильтра</li>
